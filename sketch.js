...
function setup(){
  ...
  tower=createSprite(displayWidth/2,0,displayWidth,displayHeight);
...
function SpawnDoor(){
  ...
  door.x=Math.round(random(displayWidth/2-750,displayWidth/2+750));
